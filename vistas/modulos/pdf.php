...
<head>
  ...
  <link href="../assets/lib/apollo/audio7_html5.css" rel="stylesheet" type="text/css">
  ...
  <script src="../assets/lib/apollo/js/jquery.mousewheel.min.js" type="text/javascript"></script>
  <script src="../assets/lib/apollo/js/jquery.touchSwipe.min.js" type="text/javascript"></script>
  <script src="../assets/lib/apollo/js_UNCODED/audio7_html5_pdf.js" type="text/javascript"></script>
  ...
  <script>
    ...
    function moverPagina(titulo) {
      $.ajax({
        url: '../../ajax/data.ajax.php',
        type: 'post',
        data: 'getPagePdfTitulo=' + titulo,
        cache: false,
        async: false,
        success: function(data) {
          var desiredPage = parseInt(data);
          if (desiredPage > 0) {
      ...
      <div class="xaudioplaylist">
        ...
        foreach ($audios as $key => $audio) {
          echo '<ul>
            ...
            <li class="xbuy">asasasa</li>
            <li class="xlyrics">sasasasas</li>
            <li class="xcategory">CATEGORIAS</li>
